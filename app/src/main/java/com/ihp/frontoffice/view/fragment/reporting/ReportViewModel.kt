...
import com.ihp.frontoffice.data.remote.ReportClient
import com.ihp.frontoffice.data.remote.StatusKasClient
...
//                    Toasty.info(context, "User Kosong", Toast.LENGTH_SHORT, true).show()
    ...
    fun postCashDetail(baseUrl: String, tanggal: String, shift: String, pecahanUang: PecahanUang): LiveData<com.ihp.frontoffice.data.remote.respons.Response>{
        return ihpRepository.postCashDetail(baseUrl, tanggal, shift, pecahanUang)
    }

    fun updateCashDetail(baseUrl: String, tanggal: String, shift: String, pecahanUang: PecahanUang): LiveData<com.ihp.frontoffice.data.remote.respons.Response>{
