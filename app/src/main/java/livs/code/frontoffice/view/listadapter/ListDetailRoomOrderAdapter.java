...
public class ListDetailRoomOrderAdapter extends RecyclerView.Adapter<ListDetailRoomOrderAdapter.RoomOrderViewHolder> {
    private final LayoutInflater layoutInflater;
    private List<Room> roomList;

    public ListDetailRoomOrderAdapter(Context context, ArrayList<Room> roomArrayList) {
    ...
    public RoomOrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = layoutInflater.inflate(R.layout.holder_view_detail_room_transfer, parent, false);
