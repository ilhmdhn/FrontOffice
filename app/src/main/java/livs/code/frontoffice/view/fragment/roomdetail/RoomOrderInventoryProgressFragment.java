...
import livs.code.frontoffice.view.listadapter.ListDetailInventoryOrderProgressAdapter;

/**
 * A simple {@link Fragment} subclass.
 * Use the {@link RoomOrderInventoryProgressFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RoomOrderInventoryProgressFragment extends Fragment {
    ...
    @BindView(R.id.image_discount_inventory_progress)
    ImageView imageDiscount;

    private Room room;
    private String residualTime;
    private ListDetailInventoryOrderProgressAdapter listDetailInventoryOrderProgressAdapter;
    ...
    public RoomOrderInventoryProgressFragment() {
    ...
    public static RoomOrderInventoryProgressFragment newInstance(RoomOrder roomOrder) {
        RoomOrderInventoryProgressFragment fragment = new RoomOrderInventoryProgressFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_room_order_inventory_progress, container, false);
    ...
    private void setRecycleOrderInventoryProgress() {
        listOrderInventoryProgress = (ArrayList<Inventory>) roomOrder.getInventoryOnOrderProgress();
        if (listOrderInventoryProgress.size() > 0) {
            if (null == listDetailInventoryOrderProgressAdapter) {
                listDetailInventoryOrderProgressAdapter = new ListDetailInventoryOrderProgressAdapter(getContext(), listOrderInventoryProgress);
