...
public class ListOperasionalCheckoutRoomAdapter extends RecyclerView.Adapter<ListOperasionalCheckoutRoomAdapter.RoomViewHolder> {
    private final LayoutInflater layoutInflater;
    private final Context context;
    private List<Room> roomList;

    public ListOperasionalCheckoutRoomAdapter(Context context, ArrayList<Room> roomArrayList) {
    ...
    public RoomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = layoutInflater.inflate(R.layout.holder_view_operasional_checkout_room, parent, false);
