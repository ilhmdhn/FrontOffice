...
import livs.code.frontoffice.view.listadapter.ListRoomAdapter;
...
public class ListRoomFragment extends Fragment {
    ...
    @BindView(R.id.togglegroup_state_room)
            ...
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                ...
                switch (checkedId) {
                    case R.id.toogle_all_room:
                        ...
                        break;
                    case R.id.toogle_all_room_ready:
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                        ...
                        break;
                    case R.id.toogle_all_room_chekin:
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                chipGroupRoomType.clearCheck();
                        ...
                        break;
                    case R.id.toogle_all_room_paid:
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                chipGroupRoomType.clearCheck();
                        ...
                        break;
                    case R.id.toogle_all_room_clean:
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                chipGroupRoomType.clearCheck();
