package livs.code.frontoffice.view.fragment.history;
...
import livs.code.frontoffice.view.fragment.roomdetail.RoomOrderPaymentFragment;
 ...
 * Use the {@link RoomOrderHistoryDetailFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RoomOrderHistoryDetailFragment extends Fragment {
    ...
    private String[] titles = new String[]{"Room", "Room Extends", "Order FnB", "Cancel FnB", "Progress FnB", "Promo FnB", "Promo Room", "Invoice","Payment"};
    private static String BASE_URL;


    public RoomOrderHistoryDetailFragment() {
        // Required empty public constructor
    }



    public static RoomOrderHistoryDetailFragment newInstance(String param1, String param2) {
        RoomOrderHistoryDetailFragment fragment = new RoomOrderHistoryDetailFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        room = RoomOrderHistoryDetailFragmentArgs.fromBundle(getArguments()).getRoom();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_room_order_history_detail, container, false);
    ...
    private class ViewPagerFragmentAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            switch (position) {
                ...
                case 8:
                    return RoomOrderPaymentFragment.newInstance(roomOrder);
            }
            return new Fragment();
        }
